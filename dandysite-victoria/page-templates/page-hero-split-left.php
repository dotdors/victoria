<?php
/**
 * Template Name: Hero — Split Left
 * Template Post Type: page
 *
 * Two-column hero: image on the left, content panel on the right.
...
<?php get_template_part( 'template-parts/hero', null, [ 'layout' => 'split-left' ] ); ?>
